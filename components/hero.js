        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-10 md:justify-around items-center">
            <div className="pt-2 text-gray-400 dark:text-gray-400 w-48 my-2 md:my-0">
              <img src="/img/shopifyplus.png" alt="shopify-logo" className="w-full" />
            </div>
            <div className="text-gray-400 dark:text-gray-400 w-48 my-2 md:my-0">
              <img src="/img/google.png" alt="shopify-logo" className="w-full" />
            </div>
            <div className="text-gray-400 dark:text-gray-400 w-48 my-2 md:my-0">
              <img src="/img/shopify.png" alt="shopify-logo" className="w-full" />
            </div>
            <div className="pt-1 text-gray-400 dark:text-gray-400 w-48 my-2 md:my-0">
              <img src="/img/klaviyo.png" alt="shopify-logo" className="w-full" />
            </div>
            <div className="pt-2 text-gray-400 dark:text-gray-400 w-48 my-2 md:my-0">
              <img src="/img/wordpress.png" alt="shopify-logo" className="w-full" />
            </div>
          </div>
        </div>
      </Container>
